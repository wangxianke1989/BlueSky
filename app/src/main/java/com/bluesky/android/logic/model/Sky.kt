package com.bluesky.android.logic.model
...
private val sky = mapOf(
    ...
    "CLEAR_CLOUDY_NIGHT" to Sky("多云",R.drawable.ic_partly_cloud_night,R.drawable.bg_partly_cloudy_night),
    ...
    "MODETATE_RAIN" to Sky("中雨",R.drawable.ic_moderate_rain,R.drawable.bg_rain),
